"""
Django settings for HoneyLyrics project.
...
SECRET_KEY = 'django-insecure-pmb3+q8^n*=qu(=sy)yih0p_be#&*3$gil&luyb%gm-1&uh219'
...
WSGI_APPLICATION = 'HoneyLyrics.wsgi.application'
